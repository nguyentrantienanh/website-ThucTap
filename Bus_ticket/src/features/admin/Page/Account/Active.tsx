...
function AccountActive()  {
  ...
  return (
    <>
    <div className='bg-green-100 px-2 sm:px-4 md:px-10 py-6 min-h-screen'>
            ...
            <tbody>
              {AccountActive.length > 0 ? (
                AccountActive.map((user: any, index: number) => (
                  <tr key={index} className='bg-green-50 text-xs text-gray-800 [#fff] text-nowrap space-nowrap border-b'>
                      ...
                      {user.password ? (
                        <div>
                          <input
                            ...
                            value={user.password}
                            readOnly
                            className='  px-2 py-1 rounded w-full   cursor-default'
                          />
                          <button
