...
function Uudaidatbiet() {
  const { t } = useTranslation('slider_uudai');
  const images = [
  {
    id: 1,
    src: monan,
  ...
  return (
    <>
    <div className=" ml-[-5%]  flex w-full h-220 p-5 max-[1450px]:h-120 max-[1030px]:h-100 max-[1030px]:w-300 max-[770px]:flex-col max-[770px]:w-[120%] max-[770px]:h-150  max-[770px]:ml-[-3%] max-[430px]:ml-[-7%] ">
      ...
      <div className="pl-10 max-[1030px]:pl-2  w-[30%] max-[770px]:w-full h-full bg-[#ffffff] ">
        <div className={`min-h-full flex flex-col justify-between `}>
          ...
          <ul className=" flex gap-2  max-[1030px]:invisible ">
       ...
       <div className=" mb-15 mt-[-100px] max-[770px]:mt-0 max-[1450px]:mt-[-65px] ml-[83%] max-[770px]:m-0  max-[1450px]:ml-[83%] max-[1030px]:ml-[75%] min-w-max flex flex-col gap-3">
        <div
          className=" relative  max-[770px]:static text-[18px] text-[#fff] cursor-pointer"
